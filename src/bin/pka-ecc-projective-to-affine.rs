...
const PROJ_X: [u32; 8] = [
    0x9A978F59, 0xACD1B5AD, 0x570E7D52, 0xDCFCDE43, 0x804B4227, 0x4F61DDCF, 0x1E7D8483, 0x91D6C70F,
];

const PROJ_Y: [u32; 8] = [
    0x4126885E, 0x7F786AF9, 0x5338238, 0xE5346D5F, 0xE77FC463, 0x88668BD0, 0xFD59BE31, 0x90D2F5D1,
];

const PROJ_Z: [u32; 8] = [
    0x9FC685C5, 0xFC34FF37, 0x1DCFD694, 0xF81F3C2C, 0x579C66AE, 0xD662BD9D, 0x976C80D0, 0x6F7EA3EA,
];

const R2MODN: [u32; 8] = [
    0x00000002, 0x00000000, 0xFFFFFFFA, 0x00000004, 0xFFFFFFFB, 0xFFFFFFFF, 0x00000008, 0xFFFFFFFC,
];
