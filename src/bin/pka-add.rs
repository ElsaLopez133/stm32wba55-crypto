...
const A: [u32; 8] = [
    0xC2ED62C5, 0xE9FCF0BA, 0xEAF30BB3, 0x22CE215D, 0x6694D545, 0xB235C821, 0x3BD529B5, 0x7A1C5A20,
];
...
const B: [u32; 8] = [
    0xD1F3A4C8, 0xB66E30F7, 0x8A53E5B7, 0x896AB8A2, 0xFFEFC0BD, 0xE45A7A7E, 0x13347157, 0x956C8E2A,
];
